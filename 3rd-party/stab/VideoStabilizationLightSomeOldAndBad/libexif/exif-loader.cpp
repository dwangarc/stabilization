...
typedef int ExifLoaderState;
#define EL_READ					0
#define EL_READ_SIZE_BYTE_24	1
#define EL_READ_SIZE_BYTE_16	2
#define EL_READ_SIZE_BYTE_08	3
#define EL_READ_SIZE_BYTE_00	4
#define EL_SKIP_BYTES			5
#define EL_EXIF_FOUND			6
